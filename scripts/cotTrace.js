...
(function () {
  ...
  const STEPS = [
    ...
    { kind: 'draft',
      text: 'Answer: 142 − 12 = 130.' },
    { kind: 'wait',
      text: 'Wait — let me check the multiples-of-77 count again. floor(999 / 77) = ?' },
    { kind: 'revise',
      text: '77 · 12 = 924 ✓. 77 · 13 = 1001 ✗ (over 999). So there are 12 multiples of 77 in [1, 999]. The 12 was right. But let me re-verify floor(999/7).' },
    { kind: 'revise',
      text: '7 · 142 = 994 ✓. 7 · 143 = 1001 ✗. So 142 is right.' },
    { kind: 'verify',
      text: 'Cross-check by inclusion–exclusion: |A \\ B| = |A| − |A ∩ B| = 142 − 12 = 130. Consistent.' },
    { kind: 'answer',
